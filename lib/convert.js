...
function convertWithFileCopy(program) {
    return new Promise((resolve, reject) => {
        ...
        // Clean output folder
        console.log(chalk.green.bold('Cleaning output folder...'));
        fs.emptyDirSync(program.outputDirectory);
        
        // Ccopy in the new manifest, app, assets
        console.log(chalk.green.bold('Copying data...'));
        ...
        fs.readFile(manifest, 'utf8', (err, data) => {
            console.log(chalk.green.bold('Creating manifest..'));
            let result = data;
