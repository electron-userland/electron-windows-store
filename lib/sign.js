...
module.exports.makeCert = function(program) {
    let publisherName = program.publisherName;
    let certFilePath = path.join(program.outputDirectory, 'appx', program.packageName);
    let sdkDir = program.windowsKit;
